...
We will also use 3 fold cross validation to predict the output of each algorithm.
...
The following code uses partition tree algorithm and 5 fold cross validation as control. We then reapply for the data set using the variable subset of 60 variables only for comparison and study.
```{r}
library("rattle")
...
The following code uses generalized boosting model algorithm and 5 fold cross validation as control. We then reapply for the data set using the variable subset of 60 variables only for comparison and study.
